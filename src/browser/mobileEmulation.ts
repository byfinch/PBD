 ...
 * Desktop UA + phone width still makes Google serve desktop HTML.
 */
...
/**
 * Force phone-like browsing for mobile profiles:
...
/**
 * Tap a point on a touch-emulated page (mobile SERPs answer TAP, not mouse
 * events). Chain: page.touchscreen.tap → raw CDP Input.dispatchTouchEvent
 * (works on connectOverCDP attaches where Playwright's hasTouch context option
 * is off) → mouse sequence.
 */
