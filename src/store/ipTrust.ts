...
/**
 * Long-lived per-profile Google trust state (the "vault").
 *
...
export class IpTrustStore {
   ...
   *
   * @param opts.maxCooldownMinutes Cap the ladder for THIS mark.
   */
   ...
   *  - ready: cooldown ended — can open again
   *  - cooling: next_retry_at still in the future — skip
   *  - captcha / quarantined / recovering: raw DB status counts
